...
public class Part2: ISolution
{
    ...
    private class Hand
    {
        ...
        public Hand(string cards, int bid)
        {
            ...
            var jokerCount = frequencyList
                .FirstOrDefault(card => card.Key == 'J').Value;

            var filteredList = frequencyList.Where(card => card.Key != 'J').ToArray();

            if (frequencyList[0].Value == 5 || filteredList[0].Value + jokerCount == 5 )
            {
                HandType = HandType.FiveOfAKind;
            } else if (frequencyList[0].Value == 4 || filteredList[0].Value + jokerCount == 4)
            {
                HandType = HandType.FourOfAKind;
            } else if (frequencyList[0].Value == 3 && frequencyList[1].Value == 2)
            {
                HandType = HandType.FullHouse;
            } else if (filteredList[0].Value + jokerCount == 3 && frequencyList[1].Value == 2)
            {
                HandType = HandType.FullHouse;
            } else if (frequencyList[0].Value == 3 && filteredList[1].Value + jokerCount == 2)
            {
                HandType = HandType.FullHouse;
            } else if (frequencyList[0].Value == 3 || filteredList[0].Value + jokerCount == 3 )
            {
            ...
            } else if (filteredList[0].Value + jokerCount == 2 && frequencyList[1].Value == 2)
            {
                HandType = HandType.TwoPair;
                ...
                HighestCardValue = CalculateHighestCard(mostCommonChars.ToArray());
            } else if (frequencyList[0].Value == 2 && filteredList[1].Value + jokerCount == 2)
            {
                HandType = HandType.TwoPair;
            ...
            }else if (filteredList[0].Value + jokerCount == 2)
            {
                HandType = HandType.OnePair;
            }
            else
